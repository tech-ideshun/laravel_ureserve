                ...
                <form method="POST" action="{{ route('events.update', ['event' => $event->id ]) }}">
                    ...
                    <div class="md:flex justify-between items-end">
                        ...
                        <div class="flex space-x-4 justify-around">
                            <input type="radio" name="is_visible" id="" value="1" @if($event->is_visible === 1 ){ checked }@endif>表示
                            <input type="radio" name="is_visible" id="" value="0" @if($event->is_visible === 0 ){ checked }@endif>非表示
                        </div>
